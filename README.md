...
<h1 class="msu_green">
    ...
    <img src = bathroom_men's_stalls.jpg alt="A picture of the men's bathroom" width="250" >
</div>

<h2 class="main_header">Bio</h2>
<p class="box">
...
<h2 class="main_header">The Video Game Industrial BS</h2>

<h3 class="box msu_green">Pay to play</h3>
<p class="box">
...
<h3 class="box msu_green">You don't own your games</h3>
<p class="box">
...
<h3 class="box msu_green">Video Game Companies</h3>
<p class=box>
...
<h3 class="box msu_green">Bad video game companies in my opinion</h3>
<ul class="box">
    <li>
        <h4>EA</h4>
    </li>
    ...
    <li>
        <h4>SEGA (For poor decision making on the Sonic the Hedgehog franchise)</h4>
    </li>
</ul>


<h3 class="box msu_green">My favorite games</h3>
<ol class="box">
    <li>
        <a href="https://en.wikipedia.org/wiki/Red_Dead_Redemption_2">Red Dead Redemption 2</a>
    </li>
    <li>
        <a href="https://en.wikipedia.org/wiki/Call_of_Duty:_Black_Ops_II">Call of Duty: Black Ops 2
        </a>
    </li>
    <li>
