...
<div class="vertical-marquee">
    <div class="marquee-content">
        <p class="warning_text">ATTENTION!!!</p>
        <p class="warning_text">ATTENTION!!!</p>
        <p class="warning_text">ATTENTION!!!</p>
...
<body>
    <div class="head_division">
        <img class="head_img" src = logo_msu_bathroom.png alt="The MSU Bathroom Official Logo" height="200">
        <img class="head_img" src = bathroom_men's_stalls.jpg alt="A picture of the men's bathroom" height="200">
    </div>
    ...
    <div class="song_division">
        <h2 class="item1 msu_green main_header">SONG OF THE BATHROOM</h2>
        <img src="no_te_vayas_hoy_album.jpg" class="album_img item2" alt="An image of the 1993 Los Rehenes album "Verdades Que Duelen" height="200px">
        <p class="item3">
    ...
    <div class="bio_division">
        <img class="bio_img" src="sonic_adventure_idle.gif" alt="A picture of Homelander disgusted about being asked if he fucked his biological father, Soldier Boy" width="200px">
        <div class="bio_text">
            <h2 class="main_header msu_green">About the Editor</h2>
            <p>This page was created by me, Jhair Elias, to be my personal vent space for topics and subjects that I so happened to be interested in. The page doesn't really have any coherence at all especially as you continue to read the page but rest assured, you are not missing out on much. Most of my opinions follow the opinions of the vast many that exist on the orbiting rock called Earth so reading my pages will be nothing more than something to waste your time on as you try to grasp whatever it is I am trying to say. I've never been good at speaking my mind so beware.</p>
        </div>
    </div>
</body>
</html>
